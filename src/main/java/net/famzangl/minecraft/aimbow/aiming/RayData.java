...
public abstract class RayData extends TickingEntity {
    private static final Random RANDOM=new Random(); private boolean dead; private List<Vec3> sink=new ArrayList<Vec3>();
    protected float prevRotationYaw,prevRotationPitch;
    public void setTrajectorySink(List<Vec3> s) {sink = s == null ? new ArrayList<Vec3>() : s;}
